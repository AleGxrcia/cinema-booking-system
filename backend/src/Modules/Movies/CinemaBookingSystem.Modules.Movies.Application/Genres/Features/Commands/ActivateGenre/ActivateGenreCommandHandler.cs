...
public sealed class ActivateGenreCommandHandler : ICommandHandler<ActivateGenreCommand>
{
    private readonly IGenreRepository _genreRepository;
    private readonly IUnitOfWork _unitOfWork;

    public ActivateGenreCommandHandler(IGenreRepository genreRepository, IUnitOfWork unitOfWork)
    {
        _genreRepository = genreRepository;
        _unitOfWork = unitOfWork;
    }
    public async Task<Result> Handle(ActivateGenreCommand request, CancellationToken cancellationToken)
    {
