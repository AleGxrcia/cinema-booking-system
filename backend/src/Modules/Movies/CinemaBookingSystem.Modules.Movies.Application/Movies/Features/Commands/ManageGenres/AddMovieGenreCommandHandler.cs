...
public sealed class AddMovieGenreCommandHandler : ICommandHandler<AddMovieGenreCommand>
{
    private readonly IMovieRepository _movieRepository;
    private readonly IGenreRepository _genreRepository;
    private readonly IUnitOfWork _unitOfWork;

    public AddMovieGenreCommandHandler(IMovieRepository movieRepository, IGenreRepository genreRepository,
    ...
    public async Task<Result> Handle(AddMovieGenreCommand request, CancellationToken cancellationToken)
    {
