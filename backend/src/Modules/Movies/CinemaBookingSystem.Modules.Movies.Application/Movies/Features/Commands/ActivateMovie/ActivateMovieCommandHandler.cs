...
public sealed class ActivateMovieCommandHandler : ICommandHandler<ActivateMovieCommand>
{
    ...
    public ActivateMovieCommandHandler(IMovieRepository movieRepository, IUnitOfWork unitOfWork)
    {
        _movieRepository = movieRepository;
        _unitOfWork = unitOfWork;
    }

    public async Task<Result> Handle(ActivateMovieCommand request, CancellationToken cancellationToken)
    {
